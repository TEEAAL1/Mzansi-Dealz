...
**How to apply:** Keep accepted rows durable during crawling, use bounded concurrency and retries, filter inactive products before import, and provide a protected finalize path that turns the accepted set into a reviewable CSV/import without claiming the full sitemap was processed.